/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d6cb3efbe990c9ffca2d5d9cfa158fc1)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 nodejs_compat
interface __BaseEnv_Env {
	ARENA: DurableObjectNamespace<import("./worker/index").Arena>;
	LOBBY: DurableObjectNamespace<import("./worker/index").Lobby>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Arena" | "Lobby";
	}
