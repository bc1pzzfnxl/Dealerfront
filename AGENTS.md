...
- **Guerre de quartiers (P19)** : **butin** à la capture (40 % de la valeur du bâtiment), **guetteurs** (Contre-espionnage = alerte de descente), contours de territoire **continus** (arêtes), **aménagement par lot** (chiffré), carte **24×24**, seuil de victoire **42 %**.
- **DA/UI (P16)** : palette **pastel** (factions + bâtiments colorés par type), **grille de quartiers**, **frontières** épaisses, animations (siège qui pulse, flash de capture, croissance/pop des bâtiments) ; **fog abandonné** (tout visible).
- **Conquête (P15)** : **sièges** (dégâts plafonnés, régén forte), **3 assauts simultanés max**, **Raid** payant (contrôle/bâtiments, sans capture), constructions **9–24 s**, conversion −50 %/**temps ÷2** ; diplomatie masquée (`?`/`~X %`) ; ville plus variée (gradins/enseignes/néons/cheminées).
