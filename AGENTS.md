...
- **Renseignement (P14)** : vision de frontière, zones inconnues masquées, **Reconnaître** (payant) + **Contre-espionnage** qui révèle un rayon ; code couleur réservé à notre base.
